 ...
 *
 */
function <%= themeSlugName %>_preprocess_page(&$variables) {
 ...
 */
function <%= themeSlugName %>_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
 ...
 */
function <%= themeSlugName %>_html_head_alter(&$head_elements) {
 ...
 */
function <%= themeSlugName %>_page_alter(&$page) {
...
function <%= themeSlugName %>_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function <%= themeSlugName %>_preprocess_block(&$vars, $hook) {
  // Add a striping class.
